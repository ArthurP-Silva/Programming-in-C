...
int main(void){ // início do algoritmo: função main
	...
	if(delta == 0){ // condicionamento de quando delta for IGUAL a ZERO, portanto, apenas um valor de X.
